...
class UserCrud extends ControllerBaseClass
{
	...
	public function index($title = '') 	
	{
		...
		$this->addParam('view_profile_link' , 'http://localhost:8888/pdo-abstract/profileCrud/viewSingle');
	...
	public function view($id='', $username='', $password='')  
	{
		$model = new UserModel(); 
	...
	public function viewSingle($id = '') 
	{
		...
		$this->addParam('edit_profile_link' , 'http://localhost:8888/pdo-abstract/Profilecrud/edit');
		$this->addParam('view_user_link' , 'http://localhost:8888/pdo-abstract/Profilecrud/viewSingle');
		$this->addParam('edit_user_link' , 'http://localhost:8888/pdo-abstract/Usercrud/edit');
		$this->addParam('delete_link' , 'http://localhost:8888/pdo-abstract/userCrud/delete');
		$this->addParam('title', 'View Profile');
		
		$this->callView('userViewSingle');
